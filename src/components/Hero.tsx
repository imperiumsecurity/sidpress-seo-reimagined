...
export const Hero = () => {
  return <section className="relative overflow-hidden bg-hero">
      <div className="container mx-auto px-4 mobile-lg:px-6 py-12 tablet:py-20">
        <div className="grid tablet:grid-cols-2 gap-8 tablet:gap-12 items-center">
          <div className="space-y-6 text-hero-foreground">
            ...
            <h2 className="text-2xl mobile-lg:text-3xl tablet:text-4xl font-bold">LEARN h</h2>
            ...
            <div className="pt-4">
              <a href="https://sidpress.sell.app/product/straight-to-the-point-course" target="_blank" rel="noopener noreferrer" className="inline-block bg-hero-foreground text-hero px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-opacity">
                BUY NOW - $900 USD
              </a>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center min-h-[500px] tablet:min-h-[600px]">
            <img src={heroImage} alt="SEO Course Product Box" className="w-full max-w-lg tablet:max-w-xl desktop:max-w-2xl h-auto object-contain" />
            <img src={heroBadge} alt="Straight to the Point Badge" className="absolute -bottom-4 -right-4 w-32 tablet:w-48 h-auto animate-pulse" />
          </div>
        </div>
      </div>
    </section>;
